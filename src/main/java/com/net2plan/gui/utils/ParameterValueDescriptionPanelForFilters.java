 ...
 */
public class ParameterValueDescriptionPanelForFilters extends JPanel{
    ...
    static {
        CHECKBOX_RENDERER = new ParameterValueDescriptionPanelForFilters.CheckBoxRenderer();
        HEADER = StringUtils.arrayOf("Parameter", "Value", "Description");
        PARAMETER_COMPARATOR = new ParameterValueDescriptionPanelForFilters.SortByParameterNameComparator();
    }
     ...
     * @since 0.2.0
     */
    public ParameterValueDescriptionPanelForFilters() {
        setLayout(new BorderLayout());
        Object[][] data = {{null, null, null}};

        TableModel model = new ParameterValueDescriptionPanelForFilters.ClassAwareTableModelImpl(data, HEADER);
     ...
     * @since 0.2.0
     */
    public void setParameters(java.util.List<Triple<String, String, String>> parameters) {
        ...
        if (numParameters > 0) {
            ...
            java.util.List<Triple<String, String, String>> sortedList = new LinkedList<Triple<String, String, String>>(parameters);
            ...
            while (it.hasNext()) {
                ...
                Constants.RunnableCodeType runnableCodeType = Constants.RunnableCodeType.find(aux.getSecond());
